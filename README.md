...
\*\*🔗 Live Demo:\*\* \[abinash10b-crypto-dashboard.streamlit.app](https://abinash10b-crypto-dashboard.streamlit.app/)
...
3. **Caching** — `@st.cache\_data(ttl=60)` prevents hitting the API on every
